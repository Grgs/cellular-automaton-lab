...
REGULAR_REFERENCE_FAMILY_SPECS: dict[str, ReferenceFamilySpec] = {
    "square": ReferenceFamilySpec(
        ...
        root_seed_policy="open-boundary 3x3 square grid sample",
    ...
    "hex": ReferenceFamilySpec(
        ...
        root_seed_policy="open-boundary 3x3 hex grid sample",
        allowed_public_cell_kinds=("cell",),
        required_metadata=(),
        sample_mode="grid",
        depth_expectations={
    ...
    "triangle": ReferenceFamilySpec(
        ...
        root_seed_policy="open-boundary 3x3 triangular grid sample",
        allowed_public_cell_kinds=("cell",),
        required_metadata=(),
        sample_mode="grid",
        depth_expectations={
