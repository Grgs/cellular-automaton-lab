...
- Extend direct canonical patch comparisons beyond the current exact-depth set (`square-triangle`, `shield`, `pinwheel`, `robinson-triangles`, and `tuebingen-triangle`) where the extra exactness buys materially stronger guarantees.
