...
| 6 — Regression gate      | #267/#261 | `agent/compare-browser-regressions` | —             | —                                          | Added a named `compare_workbench` Playwright gate that runs the five accessibility-first Phase 1–5 journeys against both server and standalone hosts. The gate covers shell navigation/preferences and themes, editable summary/Rule behavior, resizable desktop and narrow panels, tabs and selected actions, removal with undo/redo, Compare-to-Lab handoffs, overflow, and console/page errors.                                                                                                                                                                                                                 | Run the focused gate and PR checks, then close #267 and #261 after merge            |
