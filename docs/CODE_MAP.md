...
- [frontend/compare/compare-panel.css](../frontend/compare/compare-panel.css) and [frontend/compare/compare-options.ts](../frontend/compare/compare-options.ts)
  Injected stylesheet (imported `?inline` so it ships minified inside the compare-panel chunk) and the traversal option list.
