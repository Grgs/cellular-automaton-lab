...
export const elements: DomElements = {
    ...
    speedField: elementById("speed-field"),
    speedDownBtn: elementById("speed-down-btn"),
    speedInput: elementById("speed-input"),
    speedUpBtn: elementById("speed-up-btn"),
    speedLabel: elementById("speed-label"),
    speedActualLabel: elementById("speed-actual-label"),
    ...
    adjacencyModeLabel: elementById("adjacency-mode-label"),
