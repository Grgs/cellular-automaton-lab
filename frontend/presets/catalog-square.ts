...
const HIGHLIFE_REPLICATOR_ROWS = Object.freeze([".OO", ".O.", "O..", "O..", "OOO"]);

const HIGHLIFE_REPLICATOR_PREDECESSOR_RLE = "b3o$o$o$o!";
const HIGHLIFE_REPLICATOR_OSCILLATOR_RLE =
    "2o33b$2o10bo22b$11b2o22b$10bobo22b$9b3o23b$35b$15b3o17b$14bobo18b$14b2o19b$14bo20b$35b$35b$35b$35b$35b$35b$35b$33b2o$33b2o!";
    ...
    conway: Object.freeze([
        {
            ...
            build: ({ width, height }: PresetBuildContext) =>
                buildCenteredAsciiSeed(width, height, [".OO", "OO.", ".O."], {
                    O: 1,
                }),
        },
    ]),
    highlife: Object.freeze([
        {
            ...
            minHeight: 7,
            build: ({ width, height }: PresetBuildContext) =>
                buildHighlifeReplicator(width, height),
        },
        {
            id: "replicator-predecessor",
            label: "Replicator Predecessor",
            description:
                "A tiny four-row seed that quickly blossoms into the classic replicator family.",
            supportedGeometry: SQUARE_GEOMETRY,
            minWidth: 5,
            minHeight: 5,
            build: ({ width, height }: PresetBuildContext) =>
                buildHighlifeReplicatorPredecessor(width, height),
        },
        {
            id: "replicator-oscillator",
            label: "Replicator Oscillator",
            description:
                "A large period-96 HighLife oscillator built from interacting replicator fronts.",
            supportedGeometry: SQUARE_GEOMETRY,
            minWidth: 35,
            minHeight: 19,
            build: ({ width, height }: PresetBuildContext) =>
                buildHighlifeReplicatorOscillator(width, height),
        },
        {
            id: "bomber-predecessor",
            label: "Bomber Predecessor",
            description:
                "A small replicator-and-blinker precursor that turns into HighLife's classic bomber spaceship.",
            supportedGeometry: SQUARE_GEOMETRY,
            minWidth: 10,
            minHeight: 6,
            build: ({ width, height }: PresetBuildContext) =>
                buildHighlifeBomberPredecessor(width, height),
        },
    ]),
    wireworld: Object.freeze([
        {
            ...
            minHeight: 9,
            build: ({ width, height }: PresetBuildContext) =>
                buildWireworldSignalLoop(width, height),
        },
        {
            id: "diode-demo",
            label: "Diode Demo",
            ...
            minHeight: 11,
            build: ({ width, height }: PresetBuildContext) =>
                buildWireworldDiodeDemo(width, height),
        },
    ]),
    whirlpool: Object.freeze([
        {
            ...
            description:
                "A broken clockwise arm fed by two sources and pinned by a short refractory crescent.",
            supportedGeometry: SQUARE_GEOMETRY,
            minWidth: 12,
            minHeight: 12,
            build: ({ width, height }: PresetBuildContext) =>
                    ...
                    arms: [
                        {
                            angleOrigin: -0.64,
                            twist: 1.58,
                            normalizedRadii: [0.2, 0.26, 0.32, 0.39, 0.46, 0.53],
        ...
        },
        {
            ...
            description:
                "Two offset source anchors feed a dominant clockwise arm with a wider outer curl.",
            supportedGeometry: SQUARE_GEOMETRY,
            minWidth: 16,
            minHeight: 16,
            build: ({ width, height }: PresetBuildContext) =>
                    ...
                    arms: [
                        {
                            angleOrigin: -0.58,
                            twist: 1.54,
                            normalizedRadii: [0.2, 0.27, 0.34, 0.41, 0.49, 0.57],
                            angularOffsets: [-1.06, -0.78, -0.5, -0.22, 0.04, 0.31, 0.59, 0.88],
                            gapRanges: [[0.08, 0.42]],
                        },
                    ],
                    arcs: [
