...
- Added shareable compare run links: `run=v1.<base64url>` links restore seed/rule/traversal/grid/frame-count/tiling selections in the `#/compare` workspace without auto-running.
