...
reported through GitHub by opening a minimal issue, using private vulnerability
reporting when the report involves security-sensitive details, or contacting the
repository owner through the GitHub profile linked from the repository. All
