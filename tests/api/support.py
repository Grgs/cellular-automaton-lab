...
class ApiTestCase(unittest.TestCase):
    ...
    def build_reset_payload(
        self, **overrides: Unpack[ResetSimulationOverrides]
    ) -> ResetControlRequestPayload:
    ...
    def assert_wireworld_rule(self, payload: SimulationStatePayload) -> None:
        ...
        self.assertEqual(
            [cell_state["value"] for cell_state in payload["rule"]["states"]], [0, 1, 2, 3]
        )
    ...
    def assert_whirlpool_rule(self, payload: SimulationStatePayload) -> None:
        ...
        self.assertFalse(payload["rule"]["supports_randomize"])
        self.assertEqual(
            [cell_state["label"] for cell_state in payload["rule"]["states"]],
            [
                "Resting",
                "Excited",
                "Trailing",
